...
CREATE TABLE `alert_record` (
  ...
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '告警信息',
...
CREATE TABLE `custom_config` (
  ...
  `role` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '节点类型',
  PRIMARY KEY (`id`)
...
CREATE TABLE `middleware_param_top` (
  ...
  `role` varchar(16) COLLATE utf8_bin DEFAULT NULL COMMENT '节点类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-15 16:25:53
