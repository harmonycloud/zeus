...
CREATE TABLE `image_repository` (
  ...
  `address` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'harbor地址',
  `host_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'harbor主机地址',
