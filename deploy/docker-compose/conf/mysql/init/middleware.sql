...
CREATE TABLE `middleware_backup_address` (
  ...
  `relevance_num` int DEFAULT NULL COMMENT '关联数',
  `status` int DEFAULT NULL COMMENT '状态',
  ...
  `capacity` varchar(16) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '容量',
...
INSERT INTO `resource_menu` VALUES (6,'storageManagement','存储管理','storageManagement',6,'icon-rongzaibeifen',0,NULL);
INSERT INTO `resource_menu` VALUES (7,'backupService','备份服务','backupService',7,'icon-fuwutiaokuan',0,NULL);
...
-- Dump completed on 2022-06-20  9:57:22
