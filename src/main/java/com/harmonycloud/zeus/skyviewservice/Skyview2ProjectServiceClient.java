...
public interface Skyview2ProjectServiceClient {
     ...
     * @return
     */
    @Get(url = "/caas/tenants/{tenantId}/switchTenant", headers = {"Authorization: ${token}"})
     ...
     * @return
     */
    @Get(url = "/user/switchProject", headers = {"Authorization: ${token}"})
     ...
     * @return
     */
    @Get(url = "/caas/tenants/{tenantId}/projects", headers = {"Authorization: ${token}"})
     ...
     * @return
     */
    @Get(url = "/caas/tenants/{tenantId}/projects/{projectId}", headers = {"Authorization: ${token}"})
     ...
     * @return
     */
    @Get(url = "/caas/tenants/{tenantId}/federations/namespaces?withQuota=false", headers = {"Authorization: ${token}"})
     ...
     * @return
     */
    @Get(url = "/caas/tenants/{tenantId}/projects/{projectId}/namespaces", headers = {"Authorization: ${token}"})
