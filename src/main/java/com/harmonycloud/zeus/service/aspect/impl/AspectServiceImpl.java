...
public class AspectServiceImpl implements AspectService {
    ...
    @Override
    public void operation(MiddlewareClusterDTO cluster, Middleware middleware, Map<String, String> dynamicValues,
        JSONObject values) {
        try {
            Object service = SpringContextUtils.getBean(name);
            ...
            service.getClass().getMethod("operation", JSONObject.class, Map.class, JSONObject.class).invoke(service,
                JSONObject.parseObject(JSONObject.toJSONString(cluster)), dynamicValues, values);
        } catch (Exception e) {
            log.error("调用外部服务失败");
