...
public interface ClusterService {
     ...
     * @return
     */
    String getClusterJoinCommand(String clusterName, String apiAddress, String userToken, Boolean activeActive);
     ...
     * @return
     */
    BaseResult quickAdd(MultipartFile adminConf, String name, Boolean activeActive);
