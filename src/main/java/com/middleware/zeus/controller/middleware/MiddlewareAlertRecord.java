...
public class MiddlewareAlertRecord {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "size", value = "size", paramType = "query", dataTypeClass = String.class),
    ...
    public BaseResult<List<BeanAlertRecord>> getAlertsRecord(@PathVariable(value = "clusterId") String clusterId,
        ...
        return BaseResult.ok(middlewareAlertRecordService.list(clusterId, namespace, middlewareName, current, size, keyword));
    }
