...
public class RoleBindingServiceImpl implements RoleBindingService {
    ...
    @Override
    public void bindUser(String clusterId, String namespace, String name, String username, String clusterRole) {
        // 查询roleBinding
    ...
    @Override
    public void removeUser(String clusterId, String namespace, String username) {
        ...
        for (RoleBinding roleBinding : roleBindingList) {
            ...
            boolean update = roleBinding.getSubjects()
