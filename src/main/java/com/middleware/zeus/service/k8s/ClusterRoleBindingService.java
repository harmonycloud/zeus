...
public interface ClusterRoleBindingService {
     ...
     */
    void addUserClusterRoleBinding(String clusterId, String name, List<String> usernameList, String clusterRole);
     ...
     * @param usernameList 用户名称
     */
    void removeUserClusterRoleBinding(String clusterId, String name, List<String> usernameList);
