...
public interface MiddlewareBackupService {
     ...
     * @return
     */
    List<MiddlewareBackupRecord> backupRecords(String clusterId, String namespace, String middlewareName, String type, String backupId, String backupMode, String orderBy);
