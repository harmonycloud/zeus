...
import com.middleware.zeus.common.enums.MysqlEngineEnum;
...
import com.middleware.zeus.common.enums.middleware.MysqlDataTypeEnum;
import com.middleware.zeus.common.enums.middleware.MysqlOperationEnum;
...
import com.middleware.zeus.util.middleware.MysqlUtil;
...
public class MysqlDashboardServiceImpl implements MysqlDashboardService {
    ...
    public TableDto showTableDetail(String clusterId, String namespace, String middlewareName, String database, String table) {
        ...
        tableDto.setRowFormat(tableObj.getString("ROW_FORMAT"));
        // 设置列、索引、外键信息
